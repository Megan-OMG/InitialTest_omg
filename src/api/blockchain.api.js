...
export const addTransaction = (fromAddress, toAddress, amount, signature = '', timestamp) =>
...
export const searchExplorer = (query) =>
  client.get(ENDPOINTS.SEARCH, { params: { q: query } });
